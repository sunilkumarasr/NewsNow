...
class FuturedAdapter(// List that holds every item to be displayed in RecyclerView
    var texts: ArrayList<FeaturedArticles>
) : RecyclerView.Adapter<FuturedAdapter.ViewHolder?>() {
    ...
    override fun onBindViewHolder(holder: FuturedAdapter.ViewHolder, position: Int) {
        ...
        holder.binding.time.text = texts[position].createdAt
    ...
    class ViewHolder(val binding: FutureItemsBinding) : RecyclerView.ViewHolder(binding.root) {
