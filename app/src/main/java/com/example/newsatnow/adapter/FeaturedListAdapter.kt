...
class FeaturedListAdapter(// List that holds every item to be displayed in RecyclerView
    ...
    override fun onBindViewHolder(holder: FeaturedListAdapter.ViewHolder, position: Int) {
